                   ...
                   <td valign="top" class="center">
                       ...
                       <table id="price-content-tab" border="0" width="100%">
                           ...
                           <tr>
                               ...
                               <td>
                                   <a target="_blank" href="http://tea.crimea.ua">  <img height="80" src="http://tea.crimea.ua/img/logo.png"></a>
                               </td>
                           </tr>
                       </table>
...
//												$forprice_tov = mysql_query ("SELECT * FROM Tovari WHERE idCat='$Rowprice[id]' order by ord1 ",$db);
