...
if(isset($_POST['email'])){
	...
	$mail_to = $_POST['email'];
	$tema = 'Заказ на сайте nectar.crimea.ua';
	...
	while($row = mysql_fetch_array($query)){
		...
		$td .= '
			<tr>
				<td '.$style.' align="left"><a target="_blank" href="http://nectar.crimea.ua/goods.php?tovar='.$id_tov.'">'.$name.'</a></td>
	...
	$mpdf->SetTitle("nectar.crimea.ua");
	$mpdf->SetAuthor("nectar.crimea.ua");
	$mpdf->SetWatermarkText("nectar.crimea.ua");
	...
	$fileName = 'nectar.crimea.ua_order';
