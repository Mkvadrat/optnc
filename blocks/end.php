...
<div id="callback-frame" >
	<div id="callback-close">X</div>
...
<div class="popup-frame" id="search-ord-frame" >
...
<script>
    $(function(){
        ...
        $('#callback-frame, .popup-frame').click(function(e){
            e.stopPropagation();
        });
        
        $(document).click(function(){
            $('#callback-frame, .popup-frame').hide();
        });
